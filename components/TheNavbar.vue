...
<template>
  <div class="shadow-md navbar bg-base-100">
    <div class="flex-1">
      <NuxtLink class="text-xl normal-case btn btn-ghost" to="/">{{ siteName }}</NuxtLink>
    </div>
    <!-- Right Side -->
    <div class="flex-none">
      <div class="dropdown dropdown-end">
        ...
        <div tabindex="0" class="mt-3 shadow card card-compact dropdown-content w-52 bg-base-100">
          <div class="card-body">
            <span class="text-lg font-bold">{{ cartStore.count }} Items</span>
      ...
      <div v-if="!loggedInUser">
        <NuxtLink to="/login" class="ml-5 border-2 border-gray-100 btn btn-ghost btn-sm">Login</NuxtLink>
        <NuxtLink to="/register" class="ml-2 btn btn-primary btn-sm">Register</NuxtLink>
      </div>
